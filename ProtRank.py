...
def load_data(file_name = None,
    ...
    if only_first_ID:
        raw_data.set_index(raw_data.index.str.split(';', n=1).str[0], inplace=True)
...
def rank_proteins(data,
                  what_to_compare,
                  description = 'ProtRank_analysis',
                  prior_count = 1,
                  num_bootstrap_realizations = 100,
                  FDR_threshold = 0.1,
                  rel_rank_ZV = 0.1,
                  ignore_missed = True,
...
def evaluate_one_comparison(data,
                            prior_count,
                            pair,
                            rel_rank_ZV):
    """
...
def save_bootstrap_profile(data,
                           score,
                           score2,
                           description):
    """
